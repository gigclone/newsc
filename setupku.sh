...
wget -q https://raw.githubusercontent.com/gigclone/newsc/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
# izin
...
sleep 2
clear
wget https://raw.githubusercontent.com/gigclone/newsc/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
clear
